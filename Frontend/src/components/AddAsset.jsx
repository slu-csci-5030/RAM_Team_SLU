...
function AddAsset({ onAdd }) {
  const [asset, setAsset] = useState({ assetName: '', location: '', quantity: '' });
  ...
  const handleAdd = () => {
    if (asset.assetName.trim() !== '' && asset.location.trim() !== '' && asset.quantity.trim() !== '') {
  ...
  return (
    <>
      <div className="add-asset-container">
        <button onClick={() => setShowModal(true)} className="add-asset-button">Add Asset</button>
      </div>
        ...
        <div className="modal">
          <div className="modal-content">
            ...
            <input
              ...
              name="quantity"
            />
            <button  id="submitbutton" onClick={handleAdd}>Submit</button>
          </div>
        </div>
      )}
