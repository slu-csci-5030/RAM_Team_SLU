  ...
  return (
    <>
      <div className="add-asset-container">
        <button onClick={toggleAddAsset} className="add-asset-button">
          Add Asset
        </button>
      </div>
      ...
      {showModal && (
        <div className="add-asset-form">
            <div className="div-add-asset-form">
              <div className="add-asset-form-header">
              ...
              <div className="add-asset-container">
                ...
                <input
                  ...
                  name="modelNumber"
                />
                <div className="add-asset-checkbox">
                  <input
                    type="checkbox"
                ...
                <div className="submit-btn-container">
                  <button className="btn-submit" id="submitbutton" onClick={handleAdd}>
                    Submit
                  </button>
                </div>
              </div>
